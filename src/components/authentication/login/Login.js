module.exports = function (config, headerConfig) {
	...
	var ForgotPasswordModal = require('./ForgotPasswordModal')(config);
	var PasswordResetModal = require('./PasswordResetModal')(config);
